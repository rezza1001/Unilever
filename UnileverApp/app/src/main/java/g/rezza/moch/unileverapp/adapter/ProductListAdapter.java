...
public class ProductListAdapter extends ArrayAdapter<ProductHolder> {

    private static String TAG = "ProductOrderAdapter";
    private LayoutInflater mInflater;

    public ProductListAdapter(Context context, ArrayList<ProductHolder> values) {
        super(context, R.layout.adapter_product_list, values);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_product_list, parent, false);
            holder = new Holder();
        ...
        holder.txvw_price_00.setText("Rp. "+ Event.price);
